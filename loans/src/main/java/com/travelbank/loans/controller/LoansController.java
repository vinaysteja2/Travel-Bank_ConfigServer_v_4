...
@Tag(
        name = "CRUD REST APIs for Loans in TravelBank",
        description = "CRUD REST APIs in TravelBank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside TravelBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
